<template>
  ...
  <div class="flex justify-center w-full h-full">
      <div class="flex flex-col w-4/5 max-w-6xl py-10">
         ...
         <div v-else class="flex py-3 pl-5 mt-2 rounded items-center justify-between bg-brand-gray w-full lg:w-2/3">
         ...
         <div v-else class="py-3 pl-5 pr-20 mt-2 rounded bg-brand-gray w-full lg:w-2/3 overflow-x-scroll">
             ...
             <pre v-else>&lt;script src="https://rapcarda-feedbacker-widget.netlify.app?api_key={{store.User.currentUser.apiKey}}"&gt;&lt;/script&gt;</pre>
         </div>
      </div>
  </div>
</template>
